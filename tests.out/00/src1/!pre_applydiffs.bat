...
COPY ".\Lying File.txt" ".\.tmp\Lying File.txt"
...
MOVE ".\A Subdirectory\Moved and Unedited File.txt" ".\A Subdirectory\.tmp\Moved and Unedited File.txt"
...
MOVE ".\.tmp\Lying File.txt" ".\Created Subdirectory\New Moved Lying File.txt"
MOVE ".\.tmp\Moved and Unedited File.txt" ".\New Moved and Unedited File.txt"
...
MOVE ".\A Subdirectory\.tmp\Moved and Unedited File.txt" ".\A Subdirectory\New Moved and Unedited File.txt"
...
DEL /F ".\A Subdirectory\Moved Lying File.txt"
