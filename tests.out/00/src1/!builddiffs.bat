...
COPY "I:\--Geoff--\Software\apps\Transparent Backup.trunk\tests.in\00\src1\.\New Moved Subdirectory\Moved and Unedited File.txt" ".\New Moved Subdirectory\Moved and Unedited File.txt"
