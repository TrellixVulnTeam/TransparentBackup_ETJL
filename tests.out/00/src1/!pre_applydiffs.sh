...
cp "./Another Unmoved and Unedited File.txt" "./.tb-tmp/Another Unmoved and Unedited File.txt"
cp "./Lying File.txt" "./.tb-tmp/Lying File.txt"
mv "./Moved and Unedited File.txt" "./.tb-tmp/Moved and Unedited File.txt"
mv "./Swapped File.txt" "./.tb-tmp/Swapped File.txt"
cp "./Unmoved and Unedited File.txt" "./.tb-tmp/Unmoved and Unedited File.txt"
...
cp "./.tb-tmp/Unmoved and Unedited File.txt" "./Copied Unmoved and Unedited File.txt"
cp "./.tb-tmp/Unmoved and Unedited File.txt" "./A Subdirectory/Copied Unmoved & Unedited File.txt"
mv "./.tb-tmp/Unmoved and Unedited File.txt" "./New Moved Subdirectory/Cross-Copied Unmoved & Unedited File.txt"
cp "./A Subdirectory/.tb-tmp/Cross-Moved and Unedited File.txt" "./Cross-Moved and Unedited File.txt"
