...
cp "./.tmp/Moved and Unedited File.txt" "./New Moved and Unedited File.txt"
mv "./.tmp/Moved and Unedited File.txt" "./A Subdirectory/New Moved and Unedited File.txt"
...
rm -f "./A Subdirectory/Moved and Unedited File.txt"
